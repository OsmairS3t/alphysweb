...
export default function CardResume({title, price, icon, period}: Props) {
  return (
    <div className='flex flex-col gap-1 p-2 w-full lg:w-60 h-24 rounded-lg border-[1px] border-slate-300 hover:shadow-md hover:shadow-slate-300 transition-all'>
